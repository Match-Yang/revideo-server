    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          ...
          {comment.timestamp > 0 && <span>{formatRelativeTime(comment.timestamp)}</span>}
        </div>
      </div>
    </div>
  );
...
export const VideoComments: React.FC<VideoCommentsProps> = ({
    ...
    return (
      <AbsoluteFill style={{ backgroundColor: "#000" }}>
        ...
        <div
          style={{
            position: "absolute",
            top: videoAreaHeight + COMMENT_GAP,
            left: 0,
            right: 0,
            bottom: 0,
            backgroundColor: "#000",
  ...
  // Landscape video → portrait 9:16 canvas, video top (full width) + comments bottom
  const videoDisplayHeight = Math.round(canvasWidth / aspectRatio);

  return (
    <AbsoluteFill style={{ backgroundColor: "#000" }}>
      {/* Top: Video at full width */}
      <div
        style={{
          position: "absolute",
          top: 0,
      ...
      {/* Bottom: Scrolling comments */}
      <div
        style={{
          position: "absolute",
          top: videoDisplayHeight + COMMENT_GAP,
          left: 0,
          right: 0,
          bottom: 0,
          backgroundColor: "#000",
